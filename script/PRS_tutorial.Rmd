...
SNPs Data from Ceres Fernandez-Rozadilla et al. Nature 2023, save as: **./resources/1_CRC_SNPs_list_205_Nature_2023.xlsx**
...
```{r eval=FALSE}
# load data
CRC_SNP <- read_excel("./resources/1_CRC_SNPs_list_205_Nature_2023.xlsx")
